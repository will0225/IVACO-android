...
import com.example.myapplication.ui.measurement_reading.O2_Reading_Activity;

public class Measurement_O2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_o2);
        ...
        String video = "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/N3MCvREORVA?si=7A46K8LsPhqUAHzI\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>";
...
//        Button autoAddButton = findViewById(R.id.button_o2_automatically_add);
//        autoAddButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(Measurement_O2_Activity.this, "Auto Clicked", Toast.LENGTH_SHORT).show();
...
//        });
        ...
        // Button: Manually Add
        Button manualAddButton = findViewById(R.id.button_o2_manually_add);
        manualAddButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Measurement_O2_Activity.this, "Manually Clicked", Toast.LENGTH_SHORT).show();
    ...
    private void navigateToNextScreen() {
        Intent intent = new Intent(Measurement_O2_Activity.this, O2_Reading_Activity.class);
