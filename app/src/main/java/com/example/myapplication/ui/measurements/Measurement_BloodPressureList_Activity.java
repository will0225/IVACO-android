...
public class Measurement_BloodPressureList_Activity extends AppCompatActivity {
    private static final String TAG = "MeasurementActivity";
    private String patientId;
    private String authToken;
    private static final String MEASUREMENT_TYPE = "BLOODPRESSURE"; // Updated filter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_blood_pressure_list);
        ...
        Log.d("BloodPressureActivity", "Measurement Type: " + measurementType);
        Log.d("BloodPressureActivity", "Measurement Id: " + measurementId);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Measurement_BloodPressureList_Activity.this, Measurement_BloodPressure_Activity.class);
            ...
            call.enqueue(new Callback<List<UserMeasurement>>() {
                ...
                public void onResponse(Call<List<UserMeasurement>> call, Response<List<UserMeasurement>> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        // Filter and add only BloodPressure measurements to the list
