...
public class FamilyHistory_Reading_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_family_history_reading); // Update with your XML layout file name

        // Initialize views
        etDetails = findViewById(R.id.et_fh_details);
        etDate = findViewById(R.id.et_fh_date);
    ...
    private void submitAppointment() {
        ...
        Toast.makeText(this, "Family History Submitted successfully!", Toast.LENGTH_SHORT).show();
