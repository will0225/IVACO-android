...
public class Measurement_BloodGlucoseList_Activity extends AppCompatActivity {
    private static final String TAG = "MeasurementActivity";
    private String patientId;
    private String authToken;
    private static final String MEASUREMENT_TYPE = "BLOODGLUCOSE"; // Updated filter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_blood_glucose_list);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Measurement_BloodGlucoseList_Activity.this, Measurement_BloodGlucose_Activity.class);
            ...
            call.enqueue(new Callback<List<UserMeasurement>>() {
                ...
                public void onResponse(Call<List<UserMeasurement>> call, Response<List<UserMeasurement>> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        // Filter and add only BLOODGLUCOSE measurements to the list
    ...
    private void addMeasurementRow(UserMeasurement measurement) {
        ...
        statusTextView.setText(measurement.getStatus()); // Assuming getStatus() returns the status
