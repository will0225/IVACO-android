...
import com.example.myapplication.ui.measurement_reading.Temp_Reading_Activity;

public class Measurement_Temp_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_temp);
        ...
        String video = "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/zLji9blCPRg?si=HnhRvlHdwGiFytLB\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>";
...
//        Button autoAddButton = findViewById(R.id.button_temp_automatically_add);
//        autoAddButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(Measurement_Temp_Activity.this, "Auto Clicked", Toast.LENGTH_SHORT).show();
...
//        });
        ...
        // Button: Manually Add
        Button manualAddButton = findViewById(R.id.button_temp_manually_add);
        manualAddButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Measurement_Temp_Activity.this, "Manually Clicked", Toast.LENGTH_SHORT).show();
    ...
    private void navigateToNextScreen() {
        Intent intent = new Intent(Measurement_Temp_Activity.this, Temp_Reading_Activity.class);
