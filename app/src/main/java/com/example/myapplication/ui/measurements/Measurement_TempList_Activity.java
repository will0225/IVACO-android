...
public class Measurement_TempList_Activity extends AppCompatActivity {
    private static final String TAG = "MeasurementActivity";
    private String patientId;
    private String authToken;
    private static final String MEASUREMENT_TYPE = "TEMPERATURE"; // Updated filter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_temp_list);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Measurement_TempList_Activity.this, Measurement_Temp_Activity.class);
