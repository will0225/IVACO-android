...
public class Measurement_RespiratoryRateList_Activity extends AppCompatActivity {
    private static final String TAG = "MeasurementActivity";
    private String patientId;
    private String authToken;
    private static final String MEASUREMENT_TYPE = "RESPIRATORYRATE"; // Updated filter type
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement_respiratory_rate_list);
        ...
        Log.d("TempActivity", "Measurement Type: " + measurementType);
        Log.d("TempActivity", "Measurement Id: " + measurementId);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Measurement_RespiratoryRateList_Activity.this, Measurement_RespiratoryRate_Activity.class);
